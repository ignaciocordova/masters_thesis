...
if plot == "y":
    ...
    plt.savefig('./figures/LOSSES_past_label_informed_ViViT_img{}_ptch{}_dpth{}_hds{}_{}.png'.format(IMAGE_SIZE,
                                                                                PATCH_SIZE,
                                                                                DEPTH,
                                                                                HEADS,
                                                                                date_string))
...
# save trained model
torch.save(model.state_dict(), './models/past_label_informed_vivit.pt')
