...
answer = input(f'Create the VIDEO train, validation and test sets {N_HOURS} into the future? (y/n)')
...
if plot == "y":
    ...
    plt.savefig('./figures/LOSSES_VIVIT_NHOURS{}_img{}_ptch{}_dpth{}_hds{}_{}.png'.format(N_HOURS,
                                                                                    IMAGE_SIZE,
                                                                                    PATCH_SIZE,
                                                                                    DEPTH,
                                                                                    HEADS,
...
# save trained model
torch.save(model.state_dict(), './models/{}_nhours_vivit.pt'.format(N_HOURS))
...
if ans=='y':
    ...
    with open('./results/{}_NHOURS{}_img{}_ptch{}_dpth{}_hds{}_{}.txt'.format('vivit',
                                            N_HOURS,                           
                                            IMAGE_SIZE,
                                            PATCH_SIZE,
                                            DEPTH,
